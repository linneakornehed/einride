                                ...
                                <div className="col-md-4 press-page__text-box">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="press-main-text">
                                            Self-driving trucks are attracting a lot of investment and attention, what with Otto’s drama and platooning tech developed by key players like Peloton, but Swedish transport startup Einride has a different vision of how freight will move around roads in the future...                                   </div>
                                        <div className="press-url">
                                            <a href="https://techcrunch.com/2017/04/06/einrides-electric-self-driving-t-pod-is-a-new-kind-of-freight-transport-vehicle/" alt="Tech Crunch">Read the article <FontAwesome name='long-arrow-right'/></a>
                                        </div>
                                    </div>
                                    </div>
                                <div className="col-md-4 press-page__text-box">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="press-main-text">
                                            It looks like “an aerodynamic white box” on wheels, according to Fast Company. That’s a fair description. But it’s really a new type of vehicle being tested by Swedish start-up Einride and it could soon disrupt the transportation industry...                                    </div>
                                        <div className="press-url">
                                        <a href="https://www.washingtonpost.com/news/on-small-business/wp/2017/04/14/will-driverless-trucks-pass-these-guys-by/?tid=ss_fb-bottom&utm_term=.669673c66cbb" alt="The Washington Post">Read the article <FontAwesome name='long-arrow-right'/></a>
                                    </div>
                                    </div>
                                </div>
                                <div className="col-md-4 press-page__text-box">
                                        <div className="press-image col-md-12">
                                            ...
                                            <div className="press-main-text">
                                                    Inside a new type of truck, there are no seats and no windows. The vehicle—which founders call a “T-pod”—is the first truck to be designed to never have a human inside...                                          </div>
                                            <div className="press-url">
                                                <a href="https://www.fastcompany.com/40405140/this-autonomous-driverless-electric-pod-is-the-delivery-guy-of-the-future?partner=rss&utm_campaign=rss+fastcompany&utm_content=rss&utm_medium=feed&utm_source=rss" alt="Fast Company">Read the article <FontAwesome name='long-arrow-right'/></a>
                                            </div>
                                        </div>
                                    </div>
                            </div> 
                            <div className="row margin-bottom-2">
                                <div className="col-md-4 press-page__text-box">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="press-url">
                                            <a href="https://venturebeat.com/2017/04/07/meet-t-pod-an-autonomous-electric-truck-that-can-also-be-controlled-remotely/" alt="Venture Beat">Read the article <FontAwesome name='long-arrow-right'/></a>
                                        </div>
                                    </div>
                                    </div>
                                <div className="col-md-4 press-page__text-box">
                                    ...
                                    <div className="<col-md-12> </col-md-12>">
                                        ...
                                        Swedish transportation company Einride announced its global launch with news that it's working to establish the world's first totally emission-free road transportation system...
                                        </div>
                                         <div className="press-url">
                                            <a href="http://mashable.com/2017/04/06/einride-sustainable-autonomous-trucking/#v6C7aQysFkqx" alt="Mashable">Read the article <FontAwesome name='long-arrow-right'/></a>
                                        </div>
                                    </div>
                                    </div>
                                <div className="col-md-4 press-page__text-box">
                                        <div className="press-image col-md-12">
                                            ...
                                            <div className="press-url">
                                                <a href="http://www.dailymail.co.uk/sciencetech/article-4409650/Watch-truck-drivers-robot-coming-jobs.html?ito=social-twitter_mailonline#ixzz4e9LWjeup" alt="Daily mail">Read the article <FontAwesome name='long-arrow-right'/></a>
                                            </div>
                                        </div>
                                    </div>
                            </div> 
                            <div className="row margin-bottom-2">
                                <div className="col-md-4 press-page__text-box">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="press-main-text">
                                            En självkörande lastbil som går helt på eldrift. Det svenska företaget Einride vill leda förändringen av transportbranschen...
                                        </div>
                                        <div className="press-url">
                                            <a href="http://www.nyteknik.se/fordon/nya-svenska-ellastbilen-rattar-sig-sjalv-6841457" alt="Ny teknik">Read the article <FontAwesome name='long-arrow-right'/></a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-4 press-page__text-box">
                                ...
                                <div className="col-md-4 press-page__text-box">
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="press-main-text">
                                                スウェーデンのある企業が本日（4月7日）、運転手のいらない電気トラックを市場に投入するという野心的な新プロジェクトを立ち上げた。有害排出物の削減を見込んでいる。                                        </div>
                                        <div className="press-url">
                                            <a href="http://thebridge.jp/2017/04/meet-t-pod-an-autonomous-electric-truck-that-can-also-be-controlled-remotely" alt="the-bridge">Read the article <FontAwesome name='long-arrow-right'/></a>
                                        </div>
                                    </div>
                                    </div>
                                </div> 
